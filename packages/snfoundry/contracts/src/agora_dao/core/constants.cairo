// Rol con todos los permisos. Puede gestionar usuarios, roles, tareas y votaciones sin
// restricciones.
pub const ADMIN_ROLE: felt252 = selector!("ADMIN_ROLE");

// Responsable de la gestión de roles. Puede crear roles (USER_ROLE, PROPOSSAL_CREATOR_ROLE y
// TASK_CREATOR_ROLE).
...
// Encargado de la supervisión. Puede revisar tareas, procesos y votaciones para garantizar
// transparencia.
